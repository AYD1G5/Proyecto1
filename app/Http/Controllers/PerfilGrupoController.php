...
class PerfilGrupoController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    //Metodo para guardar nuevo tema en grupo
    public function TemaGrupoCrear(Request $request,$id)
    {
        $tema=new Tema_Grupo();
        $tema->titulo=$request->input('titulo');
        $tema->texto=$request->input('texto');
        $tema->id_CreadorTema=Auth::id();
        $tema->id_Grupo=$id;
        $tema->save();
     ...
     * @return \Illuminate\Http\Response
     */
    //Metodo para guardar nuevo comentario en grupo
    public function comentarioGrupoCrear(Request $request,$id)
    {
        $comentaio=new Comentario_Grupo();
        $comentaio->texto=$request->input('texto');
        $comentaio->id_Estudiante=Auth::id();
        $comentaio->id_Tema_Grupo=$id;
        $comentaio->save();
